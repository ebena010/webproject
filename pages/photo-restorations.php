...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Photo Restorations</title>
	...
	<body>
		...
		<?php 
			...
			if($clicked == 'menu-link'){
				...
				echo "<h2 align='center' style='color:white'>Clicked: Photo Restorations - on $clicked<h2>";
			}
			
			else if($clicked == 'l-image'){
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: $clicked (Left Image)<h2>";
			}
			
			else if($clicked == 'r-image'){
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: $clicked (Right Image)<h2>";
			}
		?>
		...
		<div align="center">
			<form action="photo-restorations.php" method="post">
		...
		<?php include '../includes/photo-restoration-photos.html'; ?>
