...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Biography</title>
	...
	<body>		
		...
		<?php 
			...
			if($clicked == 'menu-link'){
				...
				echo "<h2 align='center' style='color:white'>Clicked: Biography - on $clicked<h2>";
			}
			
			if($clicked == 'bottom-link'){
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: Biography - on $clicked<h2>";
			}
		?>
		...
		<div align="center">
			<form action="biography.php" method="post">
		...
		<?php include '../includes/bio-text.html'; ?>
