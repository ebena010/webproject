...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Work Sample</title>
	...
	<body>
		...
		<?php 
			...
			if($clicked == 'menu-link'){
				...
				echo "<h2 align='center' style='color:white'>Clicked: Work Sample - on $clicked<h2>";
			}
			...
			else if($clicked == 'bio-work-sample-link'){
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: Work Sample - on $clicked<h2>";
			}
		?>
		...
		<div align="center">
			<form action="work-sample.php" method="post">
		...
		<?php include '../includes/work-sample-photos.html'; ?>
