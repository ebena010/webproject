...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Photography Portfolio</title>
	...
	<body>
		...
		<?php 
			...
			else if($clicked == 'bio-portfolio-link'){
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: Portfolio - on $clicked<h2>";
			}
		?>
		...
		<?php include '../includes/portfolio-photos.html'; ?>		
