...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Maria and Gabriel</title>
	...
	<body>
		...
		<?php 
			...
			if($clicked == 'image'){
				...
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: Maria and Gabriel - on Menu<h2>";
			}
		?>
		...
		<div align="center">
			<form action="maria-and-gabriel.php" method="post">
		...
		<?php include '../includes/maria-and-gabriel-portfolio.html'; ?>
