...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Contact Me</title>
	...
	<body>
		...
		<?php 
			...
			if($clicked == 'menu-link'){
				...
				echo "<h2 align='center' style='color:white'>Clicked: Contact Me - on Menu<h2>";
			}
			
			else if($clicked == 'bottom-link'){
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: Contact Me - on $clicked<h2>";
			}
		?>
		...
		<?php include '../includes/contact-info.html'; ?>
