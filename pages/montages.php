...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Montages</title>
	...
	<body>
		...
		<?php 
			...
			if($clicked == 'menu-link'){
				...
				echo "<h2 align='center' style='color:white'>Clicked: Montages - on $clicked<h2>";
			}
		...
		<div align="center">
			<form action="montages.php" method="post">
		...
		<?php include '../includes/montage-photos.html'; ?>
