...
<html>
	...
	<head>
		...
		<title>Benavides, Edel - Wendy and Yiovani Engagement</title>
	...
	<body>
		...
		<?php 
			...
			if($clicked == 'image'){
				...
				echo "<h2 align='center' style='color:white'>Page Name: $pageName<h2>";
				echo "<h2 align='center' style='color:white'>Clicked: Wendy and Yiovani - on $clicked<h2>";
			}
		?>
		...
		<div align="center">
			<form action="wendy-and-yiovani.php" method="post">
		...
		<?php include '../includes/wendy-and-yiovani-portfolio.html'; ?>
